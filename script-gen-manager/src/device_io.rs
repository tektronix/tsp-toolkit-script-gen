...
impl SimulatedDeviceIO {
    pub fn new() -> Self {
        ...
        query_response_map.insert(
            ...
            String::from("2602A,2.1.1,6700037A,Simulated Device,60.0"),
        );
        query_response_map.insert(
            String::from("IDENTIFY_node[41]"),
            String::from("2612A,2.1.1,6700041A,Simulated Device,60.0"),
        );
        query_response_map.insert(
            String::from("IDENTIFY_node[45]"),
            String::from("2636A,2.1.1,6700045A,Simulated Device,60.0"),
        );
        query_response_map.insert(
            String::from("IDENTIFY"),
            String::from("2602A,2.1.1,6700001A,Simulated Device,60.0"),
        );
