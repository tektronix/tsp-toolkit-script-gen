...
// Voltage range constants for MSMU200
...
const VOLTAGE_200_V: &str = "200 V";

// Current range constants for MSMU200
...
impl Msmu200Metadata {
    ...
    pub fn new() -> Self {
        ...
        // Add ranges (with headroom beyond nominal ±200V and ±1.5A limits)
        base.add_range("source.levelv".to_string(), -202.0, 202.0);
        base.add_range("source.leveli".to_string(), -1.515, 1.515);

        base.add_range("source.limiti".to_string(), 10.0e-9, 1.515);
        base.add_range("source.limitv".to_string(), 0.02, 202.0);
        ...
        // High voltage region: ±200V source range, limited to ~±100mA continuously
        ...
        base.add_region_map(VOLTAGE_200_V, inner_region.clone());
...
impl Metadata for Msmu200Metadata {
